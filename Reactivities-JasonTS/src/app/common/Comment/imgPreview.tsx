    ...
    <div className="z-30 fixed top-0 left-0 bottom-0 right-0 bg-[rgb(0,0,0,0.7)] flex items-center justify-center">
      <div>
        ...
        <div className="flex items-center mt-6 justify-center">
          <Formik
            initialValues={{ body: "", commentImage: img, activityId: "" }}
          ...
          >
            {({ handleSubmit }) => (
              <Form className="flex" onSubmit={handleSubmit}>
                <Field
                  className="p-2 border rounded-xl w-80 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400"
                ...
                <button
                  type="submit"
                  className="flex bg-green-500 p-2 text-white items-center rounded ml-3"
                >
                  <FaPaperPlane /> Send
                </button>
              </Form>
